...
#define AME_OK 0
#define AME_EOF -1
#define AME_PARAMETER -2 //Error in parameters.
...
#define AME_INVALID_TYPE -7 //Invalid type in attrType1.
#define AME_DELETE_ERROR -8 //Error occurred while deleting file.
#define AME_INSERT_ERROR -9 //Error in insertion.
#define BF_BLOCK_LEVEL_ERROR -10 //Error occurred in a BF function.
